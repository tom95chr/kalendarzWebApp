    ...
    public void sendHtmlEmail(Reservation reservation, String recipientEmail, Character messageType, String confirmationUrl) {
        ...
        switch (messageType) {
            case 'n':
                ...
                afterCode = "Za jego pomocą możesz: " +
                        "<br> - potwierdzić swoją rezerwację w zakładce ,,POTWIERDZENIE''"+
                        "<br> - podglądnąć i ewentualnie anulować rezerwację w zakładce <br>,,MOJA REZERWACJA''";
                ...
                button = "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\">\n" +
                        ...
                        "                                  <tbody>\n" +
                        "                                    <tr>\n" +
                        "                                      <td> <a href=\""+confirmationUrl+"\" target=\"_blank\">Potwierdź rezerwację</a> </td>\n" +
                        "                                    </tr>\n" +
                        "                                  </tbody>\n" +
                        "                                </table>\n" +
                        "                              </td>\n" +
                        ...
                        "                          </tbody>\n" +
                        "</table>";
                footer = "UWAGA! Jeśli nie potwierdzisz swojej rezerwacji w przeciągu 10 minut od momentu otrzymania " +
                        "niniejszej wiadomości, to Twoja rezerwacja zostanie automatycznie usunięta, a wybrany przez " +
                        "Ciebie termin znów pojawi się jako dostępny.";
                footer2 = "Jeśli zrezygnujesz z wzięcia udziału w spotkaniu, prosimy o anulację rezerwacji poprzez " +
                        "panel ,,MOJA REZERWACJA''";
                break;
            case 'e':
                subject = "Modyfikacja spotkania";
                intro = "Witaj, Twoje spotkanie z terapeutą w Uczelnianym Centrum Wsparcia przy PWSZ w Tarnowie" +
                        " zostało edytowane.<br><br>" +
                        "SZCZEGÓŁY SPOTKANIA PO EDYCJI<br>"+
                        "specjalista:<br>"+reservation.getEvent().getTherapist().getSpecialization() +
                        " " +reservation.getEvent().getTherapist().getFirstName() + " " +
                        reservation.getEvent().getTherapist().getLastName()+"<br>"+
                        "Typ spotkania: "+ reservation.getEvent().getEventType().getEventTypeId()+
                        ...
                        "<br>Czas trwania: "+reservation.getEvent().calculateDuration()+" min."+
                        "<br>Sala nr. : "+ reservation.getEvent().getRoom() +
                        "<br><br>Kod rezerwacji:<br>";
                code = reservation.getConfirmationCode();
                afterCode = "Za jego pomocą możesz podglądnąć i ewentualnie anulować rezerwację w zakładce " +
                        ",,MOJA REZERWACJA''";
                details = "";
                button = "";
                footer = "Przepraszamy za utrudnienia. Jeśli zrezygnujesz z wzięcia udziału w spotkaniu, prosimy o " +
                        "anulację rezerwacji poprzez panel ,,MOJA REZERWACJA''";
                footer2 = "";
                break;
            case 'c':
                subject = "Odwołano Twoją rezerwację.";
                intro = "Witaj, Twoje spotkanie z terapeutą w Uczelnianym Centrum Wsparcia przy PWSZ w Tarnowie" +
                        " zostało odwołane<br><br>" +
                        "SZCZEGÓŁY ODWOŁANEGO SPOTKANIA<br>"+
                        "specjalista:<br>"+reservation.getEvent().getTherapist().getSpecialization() +
                        " " +reservation.getEvent().getTherapist().getFirstName() + " " +
                        reservation.getEvent().getTherapist().getLastName()+"<br>"+
                        "Typ spotkania: "+ reservation.getEvent().getEventType().getEventTypeId()+
